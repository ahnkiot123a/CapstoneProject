    ...
    public void changePassword(EditText edOldPassword, EditText edNewPassword,
        ...
        if(oldPassword.length()<6 ){
          //  Toast.makeText(changePasswordActivity.getApplicationContext(),"Mật khẩu có chứa 6 ký tự số trở lên, vui lòng nhập lại",Toast.LENGTH_SHORT).show();
            changePasswordActivity.setErrorEditTxt("Mật khẩu có chứa 6 ký tự số trở lên!",changePasswordActivity.getEdOldPassword());
        } else if (!validateController.getMd5(oldPassword).equals(currentUser.getPassword())) {
            changePasswordActivity.setErrorEditTxt("Mật khẩu cũ không đúng!",changePasswordActivity.getEdOldPassword());
           // Toast.makeText(changePasswordActivity.getApplicationContext(),"Mật khẩu cũ không đúng",Toast.LENGTH_SHORT).show();
        }
        else  if(newPassword.length() <6){
            //  Toast.makeText(changePasswordActivity.getApplicationContext(),"Mật khẩu có chứa 6 ký tự số trở lên, vui lòng nhập lại",Toast.LENGTH_SHORT).show();
            changePasswordActivity.setErrorEditTxt("Mật khẩu có chứa 6 ký tự số trở lên!",changePasswordActivity.getEdNewPassword());
        } else  if(confirmNewPassword.length() <6){
            //  Toast.makeText(changePasswordActivity.getApplicationContext(),"Mật khẩu có chứa 6 ký tự số trở lên, vui lòng nhập lại",Toast.LENGTH_SHORT).show();
            changePasswordActivity.setErrorEditTxt("Mật khẩu có chứa 6 ký tự số trở lên!",changePasswordActivity.getEdConfirmNewPassword());
        }
           ...
           // Toast.makeText(changePasswordActivity.getApplicationContext(),"Mật khẩu xác nhận không đúng, vui lòng nhập lại",Toast.LENGTH_SHORT).show();
            changePasswordActivity.setErrorEditTxt("Mật khẩu xác nhận không đúng!",changePasswordActivity.getEdConfirmNewPassword());

        } else if (oldPassword.equals(confirmNewPassword)){
            changePasswordActivity.setErrorEditTxt("Mật khẩu cũ và mới trùng nhau!",changePasswordActivity.getEdNewPassword());
